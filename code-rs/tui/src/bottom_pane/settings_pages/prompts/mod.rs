...
use crate::bottom_pane::settings_ui::form_page::{SettingsFormPage, SettingsFormPageLayout, SettingsFormSection};
use crate::bottom_pane::settings_ui::hints::{
    shortcut_line, status_and_shortcuts_split, title_line, KeyHint,
};
...
impl PromptsSettingsView {
    ...
    fn edit_page(&self) -> SettingsActionPage<'static> {
        let status = self
            .status
            .as_ref()
            .map(|(msg, style)| crate::bottom_pane::settings_ui::rows::StyledText::new(msg.clone(), *style));
        ...
        SettingsActionPage::new(
            "Custom Prompt",
            crate::bottom_pane::settings_ui::panel::SettingsPanelStyle::bottom_pane(),
    ...
    fn handle_edit_mouse_event_content(&mut self, mouse_event: MouseEvent, area: Rect) -> bool {
        ...
        match mouse_event.kind {
            ...
            MouseEventKind::ScrollUp => {
                if layout.sections[1].outer.contains(ratatui::layout::Position {
...
impl crate::bottom_pane::chrome_view::ChromeRenderable for PromptsSettingsView {
...
impl crate::bottom_pane::chrome_view::ChromeMouseHandler for PromptsSettingsView {
