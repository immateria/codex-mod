...
impl crate::bottom_pane::chrome_view::ChromeRenderable for AppsSettingsView {
...
impl crate::bottom_pane::chrome_view::ChromeMouseHandler for AppsSettingsView {
...
impl<'a> BottomPaneView<'a> for AppsSettingsView {
