...
pub(crate) type ShellSelectionViewFramed<'v> = crate::bottom_pane::chrome_view::Framed<'v, ShellSelectionView>;
        ...
        if self.custom_input_mode {
            ...
            return match mouse_event.kind {
                ...
                MouseEventKind::Down(MouseButton::Left) => {
                    ...
                    let field_outer =
                        Rect::new(layout.body.x, layout.body.y, layout.body.width, 3);
                    if field_outer.contains(ratatui::layout::Position {
                        x: mouse_event.column,
                        y: mouse_event.row,
                    }) {
...
impl crate::bottom_pane::chrome_view::ChromeRenderable for ShellSelectionView {
...
impl crate::bottom_pane::chrome_view::ChromeMouseHandler for ShellSelectionView {
