...
use crate::bottom_pane::settings_ui::line_runs::{scroll_top_for_section, selection_id_at, SelectableLineRun};
...
pub(crate) type ReviewSettingsViewFramed<'v> = crate::bottom_pane::chrome_view::Framed<'v, ReviewSettingsView>;
