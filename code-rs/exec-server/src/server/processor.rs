    ...
    while let Some(event) = incoming_rx.recv().await {
        match event {
            JsonRpcConnectionEvent::MalformedMessage { reason } => {
                ...
                if outgoing_tx
                    .send(RpcServerOutboundMessage::Error {
                        request_id: code_app_server_protocol::RequestId::Integer(-1),
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                code_app_server_protocol::JSONRPCMessage::Request(request) => {
                ...
                code_app_server_protocol::JSONRPCMessage::Notification(notification) => {
                ...
                code_app_server_protocol::JSONRPCMessage::Response(response) => {
                    warn!(
                ...
                code_app_server_protocol::JSONRPCMessage::Error(error) => {
                    warn!(
