...
use code_app_server_protocol::PluginAuthPolicy;
use code_app_server_protocol::PluginInstallPolicy;
...
pub fn list_marketplaces(
    ...
    Ok(list_marketplaces_outcome(additional_roots)?.marketplaces)
}

pub fn list_marketplaces_outcome(
    additional_roots: &[AbsolutePathBuf],
...
fn list_marketplaces_with_home_outcome(
    additional_roots: &[AbsolutePathBuf],
    home_dir: Option<&Path>,
) -> Result<MarketplaceListOutcome, MarketplaceError> {
