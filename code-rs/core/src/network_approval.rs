...
mod imp {
    ...
    impl NetworkApprovalService {
        ...
        pub(crate) async fn unregister_attempt(&self, _attempt_id: &str) {}
    }
...
pub(crate) use imp::NetworkApprovalService;
pub(crate) use imp::NetworkAttemptGuard;

#[cfg(feature = "managed-network-proxy")]
pub(crate) use imp::build_network_policy_decider;
