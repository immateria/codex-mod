...
pub(crate) struct ConfiguredHandler {
    pub event_name: code_protocol::protocol::HookEventName,
...
impl ClaudeHooksEngine {
    pub(crate) fn new(
        enabled: bool,
        config_layer_folders_low_to_high: &[PathBuf],
        shell: CommandShell,
    ) -> Self {
        if !enabled {
            return Self {
        ...
        let discovered = discovery::discover_handlers(config_layer_folders_low_to_high);
        Self {
